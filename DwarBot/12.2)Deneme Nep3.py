...
while True:
    try:
        ...
        # ctrl+r ve alt+a tuşlarına basarak ekranı yenile
...
#3) Nefertoya saldırır saldırmaz ekranı yenileyip avlana tekrar geçiyor.
#4) Bu esnada eğer elmas tuşuna basarsa ctrl+w ile kapatıp tekrar en başa dönüp yukarda neferto buluyor.
#5) Nefertoya tıkladığında neferto doluysa dövüş ekranına geçmez ise tekrar yukarıda neferto arıyor (3sn bekliyor burda)
#5.1) Nefertoyu bulur ve saldırırsa, dövüşe girdiğini ok setini görünce anlıyor anlamak için 3sn bekliyor. Anladığı an:
...
#7) Nefertoya saldırır saldırmaz ekranı yenileyip avlana tekrar geçiyor.
